...
describe('updateContactComponent', () => {
  ...
  let mockupdateContactService;
  let mockDataService

  beforeEach(async(() => {

    mockupdateContactService = sinon.createStubInstance(updateContactService);
    mockupdateContactService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: updateContactService, useValue: mockupdateContactService },
