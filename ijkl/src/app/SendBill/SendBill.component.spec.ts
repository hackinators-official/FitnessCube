...
describe('SendBillComponent', () => {
  ...
  let mockSendBillService;
  let mockDataService

  beforeEach(async(() => {

    mockSendBillService = sinon.createStubInstance(SendBillService);
    mockSendBillService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: SendBillService, useValue: mockSendBillService },
