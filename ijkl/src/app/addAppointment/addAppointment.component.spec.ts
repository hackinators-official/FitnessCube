...
describe('addAppointmentComponent', () => {
  ...
  let mockaddAppointmentService;
  let mockDataService

  beforeEach(async(() => {

    mockaddAppointmentService = sinon.createStubInstance(addAppointmentService);
    mockaddAppointmentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: addAppointmentService, useValue: mockaddAppointmentService },
